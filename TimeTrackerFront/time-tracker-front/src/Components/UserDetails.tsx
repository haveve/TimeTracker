...
import { RequestAddUserAbsence, RequestRemoveUserAbsence, RequestUserAbsences } from '../Redux/Requests/AbsenceRequests';
...
function UserDetails() {
  ...
  const handleShowAbcense = () => { RequestUserAbsences(parseInt(userId)).subscribe(x => setAbsences(x)); setShowAbsence(true); };
